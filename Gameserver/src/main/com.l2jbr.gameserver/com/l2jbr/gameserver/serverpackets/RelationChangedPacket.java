...
public class RelationChangedPacket extends L2GameServerPacket {
	...
	public RelationChangedPacket(L2PcInstance about, L2PcInstance target)
	{
		add(about, target);
	}

	public void add(L2PcInstance about, L2PcInstance target)
	{
	...
	private void writeRelation(RelationChangedData data)
	{
		...
		writeByte(data.isAutoAttackable ?  1 : 0);
		writeInt(data.karma);
