...
import org.l2j.gameserver.instancemanager.DayNightSpawnManager;
...
public class GameTimeController {
    ...
    /**
     * Move allTemplates L2Characters contained in movingObjects of GameTimeController.<BR>
     * <BR>
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * All L2Character in movement are identified in <B>movingObjects</B> of GameTimeController.<BR>
    ...
    private synchronized void moveObjects() {
        // Get allTemplates L2Character from the ArrayList movingObjects and put them into a table
        L2Character[] chars = _movingObjects.toArray(new L2Character[_movingObjects.size()]);

        // Create an ArrayList to contain allTemplates L2Character that are arrived to destination
        ...
        // TODO: maybe a general TP is needed for that kinda stuff (allTemplates knownlist updates should be done in a TP anyway).
        if (ended != null) {
