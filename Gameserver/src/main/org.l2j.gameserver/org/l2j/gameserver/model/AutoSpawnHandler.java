...
import org.l2j.gameserver.model.entity.database.repository.RandomSpawnRepository;
 ...
 * sequentially-based. - Also they can be used to specify the number of NPC instances to spawn using setSpawnCount(), and broadcast a message to allTemplates users using setBroadcast(). Random Spawning = OFF by default Broadcasting = OFF by default
 *
 * @author Tempy
 */
public class AutoSpawnHandler {
    ...
    /**
     * Sets the active state of allTemplates auto spawn instances to that specified, and cancels the scheduled spawn task if necessary.
     *
     * @param isActive
     */
    ...
    private class AutoSpawner implements Runnable {
        ...
        public void run() {
            try {
                ...
                // Announce to allTemplates players that the spawn has taken place, with
