...
// an owner, in allTemplates other aspects, it acts like a mob.
...
public final class L2TamedBeastInstance extends L2FeedableBeastInstance {
    ...
    private class CheckDuration implements Runnable {
        ...
        public void run() {
            ...
            // if the owner has enough food, call the item handler (use the food and triffer allTemplates necessary actions)
            if ((item != null) && (item.getCount() >= 1)) {
                ...
                // emulate a call to the owner using food, but bypass allTemplates checks for range, etc
