...
public class TvTEvent
{
	 ...
	 * 5. Teleport allTemplates participants to team spot<br>
	 * <br>
	 * @return boolean<br>
	 */
	public static boolean startFight()
	{
		...
		// teleport allTemplates participants to there team spot
	 ...
	 * 1. If both teams are at a tie(points equals), send it as system message to allTemplates participants, if one of the teams have 0 participants left online abort rewarding<br>
	 ...
	 * 4. Teleport allTemplates participants back to participation npc location<br>
	 * 5. Teams cleaning<br>
	...
	/**
	 * Send a SystemMessage to allTemplates participated players<br>
	 * 1. Send the message to allTemplates players of team number one<br>
	 * 2. Send the message to allTemplates players of team number two
	 * @param message
	 */
