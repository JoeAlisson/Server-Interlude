...
/**
 * This class manages allTemplates Castle Siege Artefacts.<BR>
 * <BR>
...
public final class L2ArtefactInstance extends L2NpcInstance
{
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the L2Character constructor to set the _template of the L2ArtefactInstance (copy skills from template to object and link calculators to NPC_STD_CALCULATOR)</li> <li>Set the name of the L2ArtefactInstance</li> <li>Create a RandomAnimation Task that will be launched after the
