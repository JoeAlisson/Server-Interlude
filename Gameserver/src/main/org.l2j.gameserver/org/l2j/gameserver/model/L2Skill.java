...
import org.l2j.gameserver.datatables.HeroSkillTable;
...
public abstract class L2Skill {
    ...
    // allTemplates times in milliseconds
    ...
    private final int _baseCritRate; // percent of success for skill critical hit (especially for PDAM & BLOW - they're not affected by rCrit values or buffs). Default loads -1 for allTemplates other skills but 0 to PDAM & BLOW
    ...
    /**
     * Return allTemplates targets of the skill in a table in function a the skill type.<BR>
     * <BR>
    ...
    public final L2Object[] getTargetList(L2Character activeChar, boolean onlyFirst) {
        ...
        switch (targetType) {
            ...
            case TARGET_MULTIFACE: {
                ...
                return targetList.toArray(new L2Character[targetList.size()]);
                // TODO multiface targets allTemplates around right now. need it to just get targets
            ...
            case TARGET_PARTY: {
                ...
                if (activeChar.getParty() != null) {
                    // Get allTemplates visible objects in a spheric area near the L2Character
