    ...
    private void setCond(int cond, int old) {
        ...
        if (completedStateFlags == 0) {
            ...
            if (cond > (old + 1)) {
                ...
                // since no flag had been skipped until now, the least significant bits must allTemplates
        ...
        // case 2: There were exist previously skipped steps
            ...
            // if this is a push back to a previous step, clear allTemplates completion flags ahead
            if (cond < old) {
