...
public class L2MerchantInstance extends L2FolkInstance {
    ...
    public void showRentPetWindow(L2PcInstance player) {
        if (!Config.LIST_PET_RENT_NPC.contains(getNpcId())) {
            return;
        }
    ...
    public void onActionShift(L2GameClient client) {
        ...
        if (player.getAccessLevel() >= Config.GM_ACCESSLEVEL) {
            ...
            html1.append("<tr><td>Template ID: " +  getNpcId()+ "</td></tr>");
            html1.append("<tr><td><br></td></tr>");
            ...
            html1.append("</table><table><tr><td><button value=\"Edit NPC\" action=\"bypass -h admin_edit_npc " + getNpcId() + "\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
            ...
            if (player.isGM()) {
                html1.append("<button value=\"View Shop\" action=\"bypass -h admin_showShop " + getNpcId() + "\" width=100 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></br>");
