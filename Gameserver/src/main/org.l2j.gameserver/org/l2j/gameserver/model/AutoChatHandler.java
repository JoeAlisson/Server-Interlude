...
public class AutoChatHandler implements SpawnListener {
    ...
    /**
     * Sets the active state of allTemplates auto chat instances to that specified, and cancels the scheduled chat task if necessary.
     *
     * @param isActive
     */
     ...
     * If an auto chat instance is set to be "global", allTemplates instances matching the registered NPC ID will be added to that chat instance.
     */
    @Override
    ...
    public class AutoChatInstance {
        ...
        /**
         * Returns a list of allTemplates NPC instances handled by this auto chat instance.
         *
