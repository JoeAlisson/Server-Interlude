...
public class L2Party {
    ...
    /**
     * returns allTemplates party members
     *
     * @return
     */
    ...
    /**
     * Send a Server->Client packet to allTemplates other L2PcInstance of the Party.<BR>
     * <BR>
     *
     * @param player
     * @param msg
    ...
    public void addPartyMember(L2PcInstance player) {
        // sends new member party window for allTemplates members
        // we do allTemplates actions before adding member to a list, this speeds things up a little
