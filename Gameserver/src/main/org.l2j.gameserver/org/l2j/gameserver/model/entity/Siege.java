...
import org.l2j.gameserver.instancemanager.SiegeManager.SiegeSpawn;
import org.l2j.gameserver.model.*;
import org.l2j.gameserver.model.L2SiegeClan.SiegeClanType;
...
public class Siege {
    ...
    public void endSiege() {
        if (getIsInProgress()) {
            ...
            removeFlags(); // Removes allTemplates flags. Note: Remove flag before teleporting players
            ...
            removeControlTower(); // Remove allTemplates control tower from this castle
            _siegeGuardManager.unspawnSiegeGuard(); // Remove allTemplates spawned siege guard from this castle
            if (getCastle().getOwnerId() > 0) {
    ...
    public void midVictory() {
        ...
        {
            if (getCastle().getOwnerId() > 0) {
                _siegeGuardManager.removeMercs(); // Remove allTemplates merc entry from db
            }
    ...
    private void removeArtifact() {
        if (_artifacts != null) {
            // Remove allTemplates instance of artifact for this castle
    ...
    /**
     * Remove allTemplates control tower spawned.
     */
    private void removeControlTower() {
        if (_controlTowers != null) {
            // Remove allTemplates instance of control tower for this castle
    ...
    private void spawnSiegeGuard() {
        ...
        // When CT dies, so do allTemplates the guards that it controls
