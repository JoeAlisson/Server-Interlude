...
import org.l2j.gameserver.datatables.TeleportLocationTable;
...
public class L2ClanHallManagerInstance extends L2FolkInstance
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(L2ClanHallManagerInstance.class);
	...
	private void doTeleport(L2PcInstance player, int val)
	{
		...
		if (list != null)
		{
			...
			else if (player.reduceAdena("Teleport", list.getPrice(), this, true))
			{
				if (Config.DEBUG)
				{
					logger.warn("Teleporting reader " + player.getName() + " for CH to new location: " + list.getLocX() + ":" + list.getLocY() + ":" + list.getLocZ());
				}
