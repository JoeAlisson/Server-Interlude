...
import org.l2j.gameserver.model.actor.knownlist.AttackableKnownList;
import org.l2j.gameserver.model.base.SoulCrystal;
...
/**
 * This class manages allTemplates NPC that can be attacked.<BR>
 * <BR>
 * L2Attackable :<BR>
 * <BR>
...
public class L2Attackable extends L2NpcInstance {
    ...
    /**
     * This class contains allTemplates RewardInfo of the L2Attackable against the any attacker L2Character, based on amount of damage done.<BR>
     * <BR>
     * <B><U> Data</U> :</B><BR>
     * <BR>
    ...
    /**
     * This class contains allTemplates AbsorberInfo of the L2Attackable against the absorber L2Character.<BR>
     * <BR>
     * <B><U> Data</U> :</B><BR>
     * <BR>
    ...
    /**
     * The table containing allTemplates autoAttackable L2Character in its Aggro Range and L2Character that attacked the L2Attackable This Map is Thread Safe, but Removing Object While Iterating Over It Will Result NPE
     */
    ...
    /**
     * Table containing allTemplates Items that a Dwarf can Sweep on this L2Attackable
     */
    ...
    /**
     * The table containing allTemplates L2PcInstance that successfully absorbed the soul of this L2Attackable
     */
            ...
            if (!rewards.isEmpty()) {
                ...
                for (Map.Entry<L2Character, RewardInfo> entry : rewards.entrySet()) {
                    ...
                    if (attackerParty == null) {
                        ...
                        // Get allTemplates L2Character that can be rewarded in the party
                        List<L2PlayableInstance> rewardedMembers = new LinkedList<>();

                        // Go through allTemplates L2PcInstance in the party
    ...
    public int getHating(L2Character target) {
        ...
        if ((ai._attacker instanceof L2PcInstance) && (((L2PcInstance) ai._attacker).isInvisible() || ai._attacker.isInvul())) {
    ...
    private RewardItem calculateCategorizedRewardItem(L2PcInstance lastAttacker, L2DropCategory categoryDrops, int levelModifier) {
        ...
        // Get default drop chance for the category (that's the sum of chances for allTemplates items in the category)
     ...
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * During a Special Event allTemplates L2Attackable can drop extra Items. Those extra Items are defined in the table <B>allNpcDateDrops</B> of the EventDroplist. Each Special Event has a start and end date to stop to drop extra Items automatically. <BR>
     * <BR>
     * <B><U> Actions</U> : </B><BR>
     * <BR>
     * <li>Manage drop of Special Events created by GM for a defined period</li> <li>Get allTemplates possible drops of this L2Attackable from L2NpcTemplate and add it Quest drops</li> <li>For each possible drops (base + quests), calculate which one must be dropped (random)</li> <li>Get each Item quantity
    ...
    public void doItemDrop(NpcTemplate npcTemplate, L2Character lastAttacker) {
        ...
        // now throw allTemplates categorized drops and handle spoil.
    ...
    /**
     * @return an array containing allTemplates L2ItemInstance that can be spoiled
     */
    ...
    /**
     * @return an array containing allTemplates L2ItemInstance that can be harvested
     */
    ...
    public void setOverhitValues(L2Character attacker, double damage) {
        ...
        if (overhitDmg < 0) {
            ...
            // let's just clear allTemplates the over-hit related values
    ...
    public void onSpawn() {
        ...
        setSpoil(false);
        // Clear allTemplates aggro char from list
        clearAggroList();
