...
public final class L2World {
    ...
    /**
     * HashMap(String Player name, L2PcInstance) containing allTemplates the players in game
     */
    ...
    /**
     * Return a collection containing allTemplates pets in game.<BR>
     * <BR>
     * <FONT COLOR=#FF0000><B> <U>Caution</U> : Read-only, please! </B></FONT><BR>
     * <BR>
     *
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Add the L2Object object in _allPlayers* of L2World</li> <li>Add the L2Object object in _gmList** of GmListTable</li> <li>Add object in _knownObjects and _knownPlayer* of allTemplates surrounding L2WorldRegion L2Characters</li><BR>
     * <li>If object is a L2Character, add allTemplates surrounding L2Object in its _knownObjects and allTemplates surrounding L2PcInstance in its _knownPlayer</li><BR>
    ...
    public void addVisibleObject(L2Object object, L2WorldRegion newRegion, L2Character dropper) {
        ...
        // Get allTemplates visible objects contained in the _visibleObjects of L2WorldRegions
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Remove the L2Object object from _allPlayers* of L2World</li> <li>Remove the L2Object object from _visibleObjects and _allPlayers* of L2WorldRegion</li> <li>Remove the L2Object object from _gmList** of GmListTable</li> <li>Remove object from _knownObjects and _knownPlayer* of allTemplates
    ...
    public void removeVisibleObject(L2Object object, L2WorldRegion oldRegion) {
        ...
        if (oldRegion != null) {
            ...
            // Go through allTemplates surrounding L2WorldRegion L2Characters
            for (L2WorldRegion reg : oldRegion.getSurroundingRegions()) {
                for (L2Object obj : reg.getVisibleObjects()) {
                    ...
                    // TODO Delete this line if allTemplates the stuff is done by the next line object.removeAllKnownObjects()
    ...
    /**
     * Return allTemplates visible objects of the L2WorldRegion object's and of its surrounding L2WorldRegion.<BR>
     * <BR>
     * <B><U> Concept</U> :</B><BR>
     * <BR>
    ...
    public List<L2Object> getVisibleObjects(L2Object object) {
        ...
        // Create an List in order to contain allTemplates visible L2Object
        List<L2Object> result = new LinkedList<>();

        // Create a List containing allTemplates regions around the current region
    ...
    /**
     * Return allTemplates visible objects of the L2WorldRegions in the circular area (radius) centered on the object.<BR>
     * <BR>
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * All visible object are identified in <B>_visibleObjects</B> of their current L2WorldRegion <BR>
    ...
    public List<L2Object> getVisibleObjects(L2Object object, int radius) {
        ...
        // Create an List containing allTemplates regions around the current region
    ...
    /**
     * Return allTemplates visible objects of the L2WorldRegions in the spheric area (radius) centered on the object.<BR>
     * <BR>
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * All visible object are identified in <B>_visibleObjects</B> of their current L2WorldRegion <BR>
    ...
    /**
     * Return allTemplates visible players of the L2WorldRegion object's and of its surrounding L2WorldRegion.<BR>
     * <BR>
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * All visible object are identified in <B>_visibleObjects</B> of their current L2WorldRegion <BR>
