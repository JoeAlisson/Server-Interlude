...
/**
 * This class manages allTemplates RaidBoss. In a group mob, there are one master called RaidBoss and several slaves called Minions.
...
public final class L2RaidBossInstance extends L2MonsterInstance
{
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the L2Character constructor to set the _template of the L2RaidBossInstance (copy skills from template to object and link calculators to NPC_STD_CALCULATOR)</li> <li>Set the name of the L2RaidBossInstance</li> <li>Create a RandomAnimation Task that will be launched after the
	...
	/**
	 * Spawn allTemplates minions at a regular interval Also if boss is too far from home location at the time of this check, teleport it home
	 */
	@Override
