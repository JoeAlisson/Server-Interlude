...
public class SkillTreeTable {
    ...
    public int getMinSkillLevel(int skillId, int skillLvl) {
        ...
        // Look on allTemplates classes for this skill (takes the first one found)
    ...
    /**
     * Returns allTemplates allowed skills for a given class.
     *
     * @param playerClass
     * @return allTemplates allowed skills for a given class.
     */
