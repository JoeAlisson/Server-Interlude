...
/**
 * This class manage drop of Special Events created by GM for a defined period. During a Special Event allTemplates L2Attackable can drop extra Items. Those extra Items are defined in the table <B>allNpcDateDrops</B>. Each Special Event has a start and end date to stop to drop extra Items automatically.<BR>
 * <BR>
 */
public class EventDroplist {
    ...
    /**
     * The table containing allTemplates DataDrop object
     */
     ...
     * <BR>
     *
     * @param items  The table containing allTemplates item identifier of this DateDrop
    ...
    /**
     * @return allTemplates DateDrop of EventDroplist allNpcDateDrops within the date range.
     */
