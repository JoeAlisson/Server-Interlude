...
public enum SystemMessageId {
	...
	/**
	 * ID: 1235<br>
	 * Message: Do you wish to delete allTemplates your friends?
	 */
	...
	/**
	 * ID: 1604<br>
	 * Message: While dressed in formal wear, you can't use items that require allTemplates skills and casting operations.
	 */
	...
	/**
	 * ID: 1439<br>
	 * Message: You do not have allTemplates of the items needed to enchant that skill.
	 */
