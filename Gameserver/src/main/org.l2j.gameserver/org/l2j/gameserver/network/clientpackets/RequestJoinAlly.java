...
import org.l2j.gameserver.network.serverpackets.AskJoinAlliancePacket;
...
public final class RequestJoinAlly extends L2GameClientPacket
{
	...
	// private static Logger logger = LoggerFactory.getLogger(RequestJoinAlly.class.getName());
