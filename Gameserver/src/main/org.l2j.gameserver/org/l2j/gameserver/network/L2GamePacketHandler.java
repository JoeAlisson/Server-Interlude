...
import org.l2j.gameserver.clientpackets.*;
 ...
 * <BR>
 * Note: If for a given exception a packet needs to be handled on more then one state, then it should be added to allTemplates these states.
 *
 * @author KenM
 */
                    ...
                    case 0xd0:
                        ...
                        switch (id3) {
                            ...
                            case 0x103:
                                ...
                                break;*/
                            case 0x104:
                                //msg = new ExSendClientINI(); Client Options size
                                break;
                           /* case 0x11D:
                            ...
                            case 0x0F:
                                ...
                                switch (type) {
                                    ...
                                    case 0x04:
                                        ...
                                        break;*/
                                    default:
                                        printDebugDoubleOpcode(opcode, type, data, state, client);
                                        break;
                                }
                                break;
                            /*case 0x10:
                            ...
                            case 0x4E:
                                ...
                                switch (id4) {
                                    ...
                                    case 0x05:
                                        ...
                                        break;*/
                                    default:
                                        printDebugDoubleOpcode(opcode, id4, data, state, client);
                                        break;
                                }
                                break;
                            /*case 0x4F:
                            ...
                            case 0x80:
                                ...
                                switch (id5) {
                                    ...
                                    case 0x0A:
                                        ...
                                        break;*/
                                    default:
                                        printDebugDoubleOpcode(opcode, id5, data, state, client);
                                        break;
                                    //case 0x0A:
                            ...
                            case 0x93:
                                ...
                                switch (id6) {
                                    ...
                                    case 0x04:
                                        ...
                                        break;*/
                                    default:
                                        printDebugDoubleOpcode(opcode, id6, data, state, client);
                                        break;
                                }
                                break;
                            /*case 0x94:
                            ...
                            case 0xAB:
                                ...
                                switch (id7) {/*
                                    ...
                                    case 0x01:
                                        ...
                                        break;*/
                                    default:
                                        printDebugDoubleOpcode(opcode, id7, data, state, client);
                                }
                                break;
                            /*case 0xAC:
