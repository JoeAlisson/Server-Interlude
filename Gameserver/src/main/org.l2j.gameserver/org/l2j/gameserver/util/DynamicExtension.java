...
public class DynamicExtension
{
	...
	/**
	 * initialize allTemplates configured extensions
	 * @return
	 */
	...
	/**
	 * call unloadExtension() for allTemplates known extensions
	 * @return
	 */
	...
	/**
	 * get allTemplates loaded extensions
	...
	/**
	 * unloads allTemplates extensions, resets the cache and initializes allTemplates configured extensions
	 */
	public void reload()
	{
		unloadExtensions();
