...
import org.l2j.gameserver.model.actor.instance.L2ControllableMobInstance.ControllableAIAcessor;
...
public class L2ControllableMobAI extends L2AttackableAI<ControllableAIAcessor> {
    ...
    protected void thinkAttackGroup() {
        ...
        try {
            ...
            range = actor.getPhysicalAttackRange() + (int) actor.getCollisionRadius() + (int) target.getCollisionRadius();
            max_range = range;
        } catch (NullPointerException e) {
            _log.warn("Encountered Null Value.");
            e.printStackTrace();
    ...
    protected void thinkForceAttack() {
        ...
        try {
            ...
            range = _actor.getPhysicalAttackRange() + (int) _actor.getCollisionRadius() + (int) getForcedTarget().getCollisionRadius();
            max_range = range;
        } catch (NullPointerException e) {
            _log.warn("Encountered Null Value.");
            e.printStackTrace();
