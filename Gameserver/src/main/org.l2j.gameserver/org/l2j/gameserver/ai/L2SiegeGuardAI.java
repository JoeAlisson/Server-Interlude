...
public class L2SiegeGuardAI extends L2AttackableAI<L2SiegeGuardInstance.AIAccessor> implements Runnable {
     ...
     * <li>If the actor is Aggressive and can attack, add allTemplates autoAttackable L2Character in its Aggro Range to its _aggroList, chose a target and order to attack it</li>
	...
	private void attackPrepare() {
		...
		try {
			...
			range = actor.getPhysicalAttackRange() + (int) actor.getCollisionRadius() + (int) _attackTarget.getCollisionRadius();
		}
