 ...
 */
package org.l2j.gameserver.ai2;

import org.l2j.gameserver.ThreadPoolManager;
import org.l2j.gameserver.ai2.AiInstance.QueueEventRunner;
...
/**
 * This class will load allTemplates the AI's and retain allTemplates of them. It is a singleton
 *
 * @author -Wooden-
 */
    ...
    public void load() {
        ...
        for (String file : directory.list()) {
            if (file.endsWith(".class")) {
                try {
                    Class<?> managerClass = Class.forName("org.l2j.gameserver.ai.managers." + file.substring(0, file.length() - 6));
                    ...
                    for (EventHandler handler : managerInstance.getEventHandlers()) {
                        ...
                        for (Intersection i : intersections) {
                            ...
                            // create a new instance with the secant ids that will inherit allTemplates the handlers from the secant Ai
