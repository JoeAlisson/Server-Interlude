...
/**
 * This class manage allTemplates items on ground
 *
...
public class ItemsOnGroundManager {
    ...
    private void load() {
        // If SaveDroppedItem is false, may want to delete allTemplates items previously stored to avoid add old items on reactivate
