...
public class MercTicketManager {
    ...
    // TODO move allTemplates these values into siege.properties
    ...
    /**
     * Delete allTemplates tickets from a castle; remove the items from the world and remove references to them from this class
     *
     * @param castleId
     */
