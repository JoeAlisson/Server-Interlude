...
public class AdminSkill implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        ...
        if (command.equals("admin_show_skills")) {
            ...
            if (activeChar.getTarget() instanceof L2PcInstance) {
                ...
                activeChar.sendMessage("You removed allTemplates skills from " + player.getName());
                player.sendMessage("Admin removed allTemplates skills from you.");
    ...
    /**
     * This function will give allTemplates the skills that the target can learn at his/her level
     *
     * @param activeChar
     */
    ...
    private void adminGetSkills(L2PcInstance activeChar) {
        ...
        if (player.getName().equals(activeChar.getName())) {
            ...
            activeChar.sendMessage("You now have allTemplates the skills of " + player.getName() + ".");
    ...
    private void adminResetSkills(L2PcInstance activeChar) {
        ...
        if (adminSkills == null) {
            ...
            activeChar.sendMessage("You now have allTemplates your skills back.");
            adminSkills = null;
            activeChar.sendSkillList();
        }
        showMainPage(activeChar);
