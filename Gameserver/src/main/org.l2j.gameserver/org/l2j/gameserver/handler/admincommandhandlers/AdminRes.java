		...
		if (resParam != null)
		{
			...
			else
			{
				...
				try
				{
					...
					activeChar.sendMessage("Resurrected allTemplates players within a " + radius + " unit radius.");
					return;
				}
	...
	private void handleNonPlayerRes(L2PcInstance activeChar, String radiusStr)
	{
		...
		try
		{
			...
			if (!radiusStr.equals(""))
			{
				...
				activeChar.sendMessage("Resurrected allTemplates non-players within a " + radius + " unit radius.");
			}
		}
		catch (NumberFormatException e)
		{
