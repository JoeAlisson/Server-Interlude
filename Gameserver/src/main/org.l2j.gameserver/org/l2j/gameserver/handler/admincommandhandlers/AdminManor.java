...
/**
 * Admin comand handler for Manor System This class handles following admin commands: - manor_info = shows info about current manor state - manor_approve = approves settings for the next manor period - manor_setnext = changes manor settings to the next day's - manor_reset castle = resets allTemplates manor
 * data for specified castle (or allTemplates) - manor_setmaintenance = sets manor system under maintenance mode - manor_save = saves allTemplates manor data into database - manor_disable = disables manor system
 *
 * @author l3x
 */
public class AdminManor implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar) {
        ...
        if (command.equals("admin_manor")) {
            ...
            activeChar.sendMessage("Manor System: allTemplates data saved");
            showMainPage(activeChar);
