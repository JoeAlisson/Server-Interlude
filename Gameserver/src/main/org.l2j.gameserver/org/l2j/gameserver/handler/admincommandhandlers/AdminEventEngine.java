...
public class AdminEventEngine implements IAdminCommandHandler {
    ...
    void showEventControl(L2PcInstance activeChar) {
        ...
        if (!npcsDeleted) {
            replyMSG.append("<tr><td><button value=\"Start\" action=\"bypass -h admin_event_control_begin\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td><font color=\"LEVEL\">Destroys allTemplates event npcs so no more people can't participate now on</font></td></tr>");
        }
        replyMSG.append("<tr><td>&nbsp;</td></tr>");
        ...
        replyMSG.append("<tr><td>&nbsp;</td></tr>");
        replyMSG.append("<tr><td><button value=\"Kill\" action=\"bypass -h admin_event_control_kill $team_number\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td><font color=\"LEVEL\">Finish with the life of allTemplates the players in the selected team</font></td></tr>");
        replyMSG.append("<tr><td>&nbsp;</td></tr>");
        ...
        replyMSG.append("<tr><td>&nbsp;</td></tr>");
        replyMSG.append("<tr><td><button value=\"End\" action=\"bypass -h admin_event_control_finish\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td><font color=\"LEVEL\">Will finish the event teleporting back allTemplates the players</font></td></tr>");
