...
/**
 * This class handles following admin commands: - gmchat text = sends text to allTemplates online GM's - gmchat_menu text = same as gmchat, displays the admin panel after chat
