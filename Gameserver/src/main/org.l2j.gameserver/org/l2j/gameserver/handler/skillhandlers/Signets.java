...
import org.l2j.gameserver.model.zone.type.L2DynamicZone;
...
public class Signets implements ISkillHandler
{
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		zone.setZoneForm(new ZoneCylinder(activeChar.getX(), activeChar.getY(), activeChar.getZ() - 200, activeChar.getZ() + 200, skill.getSkillRadius()));
