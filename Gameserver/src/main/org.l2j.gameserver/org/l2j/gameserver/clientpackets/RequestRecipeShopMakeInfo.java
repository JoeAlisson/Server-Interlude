...
import org.l2j.gameserver.serverpackets.RecipeShopItemInfo;
...
public final class RequestRecipeShopMakeInfo extends L2GameClientPacket
{
	...
	// private static Logger logger = LoggerFactory.getLogger(RequestRecipeShopMakeInfo.class.getName());
