...
import org.l2j.gameserver.serverpackets.PledgeShowMemberListAll;
...
public final class RequestPledgeMemberList extends L2GameClientPacket
{
	...
	// private static Logger logger = LoggerFactory.getLogger(RequestPledgeMemberList.class.getName());
