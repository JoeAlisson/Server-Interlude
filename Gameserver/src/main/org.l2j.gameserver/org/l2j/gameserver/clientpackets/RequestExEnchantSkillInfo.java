...
import org.l2j.gameserver.serverpackets.ExEnchantSkillInfo;
...
{
	// private static Logger logger = LoggerFactory.getLogger(RequestAquireSkill.class.getName());
	...
	protected void runImpl()
	{
		...
		{
			// logger.warn("enchant skill id " + _skillID + " level " + _skillLvl
