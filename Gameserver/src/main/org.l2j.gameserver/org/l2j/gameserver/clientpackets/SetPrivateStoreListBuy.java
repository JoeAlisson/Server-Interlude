...
import org.l2j.gameserver.serverpackets.PrivateStoreManageListBuy;
import org.l2j.gameserver.serverpackets.PrivateStoreMsgBuy;
...
public final class SetPrivateStoreListBuy extends L2GameClientPacket
{
	...
	// private static Logger logger = LoggerFactory.getLogger(SetPrivateStoreListBuy.class.getName());
