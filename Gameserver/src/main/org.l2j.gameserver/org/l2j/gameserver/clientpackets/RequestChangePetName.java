...
import org.l2j.gameserver.datatables.PetNameTable;
...
public final class RequestChangePetName extends L2GameClientPacket
{
	...
	// private static Logger logger = LoggerFactory.getLogger(RequestChangePetName.class.getName());
	...
	protected void runImpl()
	{
		...
		else if (PetNameTable.getInstance().doesPetNameExist(_name, pet.getTemplateId()))
		{
