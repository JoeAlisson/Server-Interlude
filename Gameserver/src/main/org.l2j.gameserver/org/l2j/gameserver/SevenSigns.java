...
import org.l2j.gameserver.model.AutoSpawnHandler;
import org.l2j.gameserver.model.AutoSpawnHandler.AutoSpawnInstance;
import org.l2j.gameserver.model.L2World;
import org.l2j.gameserver.model.actor.instance.L2PcInstance;
import org.l2j.gameserver.model.entity.database.SevenSignsPlayer;
...
public class SevenSigns {
    ...
    /**
     * Registers allTemplates random spawns and auto-chats for Seven Signs NPCs, along with spawns for the Preachers of Doom and Orators of Revelations at the beginning of the Seal Validation period.
     */
    ...
    /**
     * Used to reset the cabal details of allTemplates players, and update the database.<BR>
    ...
    /**
     * Sends the built-in system message specified by sysMsgId to allTemplates online players.
     *
     * @param sysMsgId
     */
    ...
    /**
     * Only really used at the beginning of a new cycle, this method resets allTemplates seal-related data.
     */
    ...
    private void calcNewSealOwners() {
        ...
        for (Integer currSeal : Arrays.asList(SEAL_AVARICE, SEAL_GNOSIS, SEAL_STRIFE)) {
            ...
            // Alert allTemplates online players to new seal status.
            switch (currSeal) {
                case SEAL_AVARICE:
    ...
    /**
     * The primary controller of period change of the Seven Signs system. This runs allTemplates related tasks depending on the period that is about to begin.
     *
     * @author Tempy
     */
        ...
        public void run() {
            ...
            switch (periodEnded) {
                ...
                case PERIOD_SEAL_VALIDATION: // Reset for New Cycle
                    ...
                    // Reset allTemplates data
                    resetPlayerData();
                    resetSeals();

                    // Reset allTemplates Festival-related data and remove any unused blood offerings.
            ...
            // Make sure allTemplates Seven Signs data is saved for future use.
