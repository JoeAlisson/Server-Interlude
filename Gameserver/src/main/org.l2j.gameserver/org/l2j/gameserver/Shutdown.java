...
/**
 * This class provides the functions for shutting down and restarting the server It closes allTemplates open clientconnections and saves allTemplates data.
...
public class Shutdown extends Thread
{
	...
	/**
	 * this function is called, when a new thread starts if this thread is the thread of getInstance, then this is the shutdown hook and we save allTemplates data and disconnect allTemplates clients. after this thread ends, the server will completely exit if this is not the thread of getInstance, then this is a
	...
	public void run()
	{
		...
		if (this == _instance)
		{
			// ensure allTemplates services are stopped
			try
			{
			...
			// last byebye, save allTemplates data and quit this server
	...
	/**
	 * this counts the countdown and reports it to allTemplates players countdown is aborted if mode changes to ABORT
	 */
	...
	/**
	 * this sends a last byebye, disconnects allTemplates players and saves data
	 */
	private void saveData()
	{
		...
		// Save allTemplates raidboss status ^_^
	...
	/**
	 * this disconnects allTemplates clients from the server
	 */
